class HeatMap():
    @staticmethod
    def plot_mat(df, clim=None, title=None, xlabel=None, ylabel=None, xticklabels=None,
                 yticklabels=None):

        df_freq = Joints.calculate_joints(df, x_bin_size=0.5, y_bin_size=0.5)
    ...
    @staticmethod
    def plot_mats(df_matrix, ax_shape, title=None, xlabel=None, ylabel=None, x_max=None, outputfile=None):
...
df = pd.DataFrame({'x': np.random.normal(1, 1, 50),
